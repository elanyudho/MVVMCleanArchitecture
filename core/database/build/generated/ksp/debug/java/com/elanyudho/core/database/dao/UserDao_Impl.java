...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`name`,`email`,`avatarUrl`,`lastUpdatedAt`) VALUES (?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(5, entity.getLastUpdatedAt());
      }
    };
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpId,_tmpName,_tmpEmail,_tmpAvatarUrl,_tmpLastUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  public Flow<List<UserEntity>> observeAllUsers() {
    final String _sql = "SELECT * FROM users ORDER BY lastUpdatedAt DESC";
      ...
      public List<UserEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpLastUpdatedAt;
            _tmpLastUpdatedAt = _cursor.getLong(_cursorIndexOfLastUpdatedAt);
            _item = new UserEntity(_tmpId,_tmpName,_tmpEmail,_tmpAvatarUrl,_tmpLastUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
